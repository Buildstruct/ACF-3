...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Bool", "ForceSteering", { KeyName = "forceawd", Edit = { type = "Bool", order = 16, category = "Miscellaneous", tooltip = "Override to consider mobility as all wheel drive"  } } )
